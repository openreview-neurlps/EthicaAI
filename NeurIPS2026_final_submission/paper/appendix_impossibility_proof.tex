...
The conjectured scaling is strongly corroborated by experiments: across all tested scales $N \in \{5, 10, 20, 50, 100\}$, five algorithm families (REINFORCE, PPO, IQL, QMIX, LOLA), four architectures, and $400{+}$ hyperparameter configurations, the Nash Trap captures 100\% of runs with 0\% escape over 500 episodes (20 seeds per condition).
\qedhere
