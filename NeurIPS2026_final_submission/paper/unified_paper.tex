...
\begin{itemize}
    \item \textbf{Algorithm Scope}: Whether risk-sensitive objectives or dynamic externality-pricing mechanisms can escape the Trap remains open. While empirical CVaR objectives fail (Appendix~\ref{app:robustness}), developing full Constrained Policy Optimization (CPO) algorithms with parameterized safety constraints on $R_t$ offers a promising future direction.
