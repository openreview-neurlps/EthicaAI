...
\begin{enumerate}
    ...
    This failure is consistent across five algorithm families (REINFORCE, PPO, IQL, QMIX~\citep{rashid2018qmix}, LOLA~\citep{foerster2018learning}; seven implementations) under a unified fair-comparison protocol.
