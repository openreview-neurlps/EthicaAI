...
Together, these results establish a \textbf{Moral Commitment Spectrum}: local incentive misalignment explains why commitment is disfavored, tipping-point dynamics explain when under-commitment becomes catastrophic, and recovery severity determines how much commitment is required for escape.
\end{abstract}
...
Together, these results establish a \textbf{Moral Commitment Spectrum}: local incentive misalignment explains \emph{why} commitment is disfavored, tipping-point dynamics explain \emph{when} under-commitment becomes catastrophic, and recovery severity determines \emph{how much} commitment is required for escape.
...
\midrule
Baseline severe & 51.7\% & 99.5\% & 99.8\% & 99.5\% \\
Near-tipping ($R_0{=}0.17$) & 7.1\% & 46.4\% & \textbf{65.2\%} & 61.4\% \\
Long horizon ($T{=}200$) & 0.0\% & 99.4\% & 99.8\% & 99.5\% \\
Shock burst ($p{=}0.15$) & 0.4\% & 34.6\% & \textbf{56.0\%} & 50.8\% \\
Combined worst & 0.0\% & 0.1\% & \textbf{1.3\%} & 0.0\% \\
\bottomrule
\end{tabular}
\\[2pt]
...
MAPPO~\citep{yu2022surprising} & 4,546$^\dagger$ & 0.223 $\pm$ 0.027 & 12.2 & 22.8 \\
IQL$^\ddagger$ & 5,195 & 0.584 $\pm$ 0.021 & 71.8 & 24.9 \\
QMIX$^\S$~\citep{rashid2018qmix} & 7,948$^\|$ & 0.511 $\pm$ 0.005 & 80.0 & 24.3 \\
LOLA$^{\#}$~\citep{foerster2018learning} & 5 & 0.498 $\pm$ 0.001 & 55.0 & 21.2 \\
\midrule
...
\midrule
Selfish RL$^\dagger$ (Byz=0\%) & 26.0 & 0.497 & 95.0 \\
Selfish RL$^\dagger$ (Byz=30\%) & 24.2 & 0.497 & \textbf{53.7} \\
\midrule
...
We establish the \textbf{Moral Commitment Spectrum} as a diagnostic framework for when commitment becomes necessary for collective survival in multi-agent systems. Our results separate three logically distinct layers. First, when $M/N < 1$, each agent faces a persistent local anti-commitment incentive. Second, when such incentive misalignment operates in environments with tipping-point collapse dynamics, under-commitment becomes an extinction-type \emph{Nash Trap}: a locally stable equilibrium that is individually rational yet collectively catastrophic. Third, recovery severity determines the size of the commitment floor required for escape. In severe regimes, the required floor exceeds the feasible range and therefore saturates at unconditional commitment, $\phi_1=1.0$; in milder regimes, partial floors suffice.
