...
\item \textbf{Experiments}:
  ...
  \end{enumerate}
\item \textbf{Code and Data}: Anonymized code repository provided. All experiments are reproducible via \texttt{reproduce\_all.py} (one-click pipeline, 9 experiments: 5 core + 4 extension). Seed counts per experiment are listed in Table~\ref{tab:seed_summary}. [Yes]
