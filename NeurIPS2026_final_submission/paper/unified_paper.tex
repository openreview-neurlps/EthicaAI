...
\begin{table}[t]
\centering
\caption{Situational brittleness under stress conditions (non-linear PGG, 20 seeds, 200 episodes). Under combined worst-case conditions, situational survival drops to $16.6\%$ while unconditional floors still achieve $47.2\%$---a $2.8{\times}$ gap. Tail-risk (5th percentile) shows even sharper divergence.}
\label{tab:stress_test}
\begin{tabular}{lccc}
\toprule
\textbf{Stress Condition} & \textbf{Selfish RL} & \textbf{Situational} & \textbf{Unconditional} \\
\midrule
Baseline severe & 100.0\% & 100.0\% & 100.0\% \\
Near-tipping ($R_0{=}0.17$) & 83.9\% & 88.9\% & \textbf{98.6\%} \\
Shock burst ($p{=}0.15$) & 60.4\% & 89.4\% & \textbf{95.9\%} \\
Combined worst & 0.4\% & 16.6\% & \textbf{47.2\%} \\
\bottomrule
\end{tabular}
\end{table}
