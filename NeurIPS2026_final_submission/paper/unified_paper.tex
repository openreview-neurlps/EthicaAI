...
\textbf{Note}: These survival rates (2--11\%) differ from the main Table~\ref{tab:sota} (26--72\%) because the sensitivity analysis deliberately tests more hostile $f(R_t)$ parameterizations (lower $R_{\text{crit}}$, reduced recovery rates) than the default configuration.
