...
Confirmed for $N \in \{5,\ldots,100\}$. Part~(i) is proved formally; Part~(ii) is supported by rigorous empirical evidence (a full measure-theoretic proof is left to future work). Lagrangian relaxation baselines, CTDE with global critics, and neural network policies all fall into the same trap (Appendices~\ref{app:comm_ctde_neural},~\ref{app:cpr_detail}).
